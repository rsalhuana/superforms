...
if(isset($_POST["ciudad_id"]) && !empty($_POST["ciudad_id"]) && $_POST["ciudad_id"] != 'CIU11'){
    $locales = mysql_query("select * from Local l Join Asignacion a on l.idLocal = a.idLocal"  
    . " Where idCiudad = '" .  $_POST['ciudad_id'] 
    . "' AND a.idUsuario = ". $_SESSION['userid'] 
    . " AND a.idSemana = " . $_POST['semana_id']  
    . " Order by Local ASC");
...
if(isset($_POST["ciudad_id"]) && !empty($_POST["ciudad_id"]) && $_POST["ciudad_id"] == 'CIU11'){
    $Distritos = mysql_query("select * from Distrito"
    . " Where idCiudad = '" .  $_POST['ciudad_id'] 
...
if(isset($_POST["distrito_id"]) && !empty($_POST["distrito_id"])){
    ...
    $locales = mysql_query("Select * FROM Local l Join Asignacion a on l.idLocal = a.idLocal"
    . " WHERE idDistrito = '" . $_POST['distrito_id'] 
    . "' AND a.idUsuario = ". $_SESSION['userid'] 
    . " AND a.idSemana = " . $_POST['semana_id']  
    . " Order by Local ASC");
    echo '<option value="">Seleccione Local</option>';
